...
class _$NotificationItemImpl implements _NotificationItem {
  ...
  @override
  String toString() {
    return 'NotificationItem(id: $id, recipient: $recipient, title: $title, body: $body, type: $type, payload: $payload, isRead: $isRead, createdAt: $createdAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, recipient, title, body, type,
      const DeepCollectionEquality().hash(_payload), isRead, createdAt);
